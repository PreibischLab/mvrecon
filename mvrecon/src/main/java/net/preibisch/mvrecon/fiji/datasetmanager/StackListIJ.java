...
public abstract class StackListIJ extends StackList implements MultiViewDatasetDefinition{
	...
	protected boolean queryGeneralInformation()
	{
		...
		String title = "Manual Loader (TIFF only, ImageJ Opener)";
		gd.addMessage( "File reader: " + title, new Font( Font.SANS_SERIF, Font.BOLD, 14 ) );
