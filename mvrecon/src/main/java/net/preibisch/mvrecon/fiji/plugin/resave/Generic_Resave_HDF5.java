...
public class Generic_Resave_HDF5 implements PlugIn
{
	...
	public void run( final String arg )
	{
		...
		// write hdf5
		GenericResaveHDF5Core.writeHDF5( spimData, params, progressWriter );
		...
		throws SpimDataException
	{
		...
		final ArrayList< Partition > partitions = GenericResaveHDF5Core.getPartitions( spimData, params );
