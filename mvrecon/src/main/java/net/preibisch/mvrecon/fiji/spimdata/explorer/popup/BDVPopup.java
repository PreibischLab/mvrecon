...
import net.preibisch.mvrecon.fiji.plugin.util.IJUtils;
...
//					forceBDVReload( s );
			...
			final String xml )
	{
		...
		BigDataViewer bdv = BigDataViewer.open( spimData, xml, IJUtils.getProgressWriter(), ViewerOptions.options() );
