...
import net.preibisch.mvrecon.process.fusion.FusionToolsGui;
		...
		public void actionPerformed( final ActionEvent e )
		{
			...
			new Thread( new Runnable()
			{
				...
				public void run()
				{
					...
					final ImagePlus imp = FusionToolsGui.display( FusionTools.fuseVirtual( spimData, views, defaultUseBlending, false, defaultInterpolation, bb, downsampling, null ).getA(), imgType );
