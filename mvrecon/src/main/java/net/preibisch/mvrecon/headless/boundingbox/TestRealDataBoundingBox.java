...
public class TestRealDataBoundingBox
{
	public static void main( String[] args ) throws SpimDataException
	{
		...
		FusionToolsGui.displayCopy( FusionTools.fuseVirtual( spimData, viewIds, true, false, 1, bb, 2.0, null ).getA(), estimation.getMinIntensity(), estimation.getMaxIntensity() ).show();
	}
}
