...
//        hdf5File = new File(seqFile.getPath().substring( 0, seqFile.getPath().length() - 4 ) + ".h5");
       ...
       Parameters newParameters = new GenericResaveHDF5Core.Parameters(
        ...
        // write hdf5
        GenericResaveHDF5Core.writeHDF5(Resave_HDF5.reduceSpimData2(data, viewIds), newParameters, progressWriter);
