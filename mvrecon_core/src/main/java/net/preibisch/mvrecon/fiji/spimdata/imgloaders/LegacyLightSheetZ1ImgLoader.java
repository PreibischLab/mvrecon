...
public class LegacyLightSheetZ1ImgLoader extends AbstractImgFactoryImgLoader
{
	...
	public static final < T extends RealType< T > > void readUnsignedShorts( final byte[] b, final Cursor< T > cursor, final int width, final boolean isLittleEndian )
	{
		...
		{
			cursor.fwd();
			cursor.get().setReal( LegacyStackImgLoaderLOCIUtils.getShortValueInt( b, ( cursor.getIntPosition( 0 ) + cursor.getIntPosition( 1 ) * width ) * 2, isLittleEndian ) );
		}
	}
	...
	{
		for ( int i = 0; i < numPx; ++i )
			cursor.next().setReal( LegacyStackImgLoaderLOCIUtils.getShortValueInt( b, i * 2, isLittleEndian ) );
	}
	...
	public static final < T extends RealType< T > > void readSignedShorts( final byte[] b, final Cursor< T > cursor, final int width, final boolean isLittleEndian )
	{
		...
		{
			cursor.fwd();
			cursor.get().setReal( LegacyStackImgLoaderLOCIUtils.getShortValue( b, ( cursor.getIntPosition( 0 ) + cursor.getIntPosition( 1 ) * width ) * 2, isLittleEndian ) );
		}
	}
	...
	{
		for ( int i = 0; i < numPx; ++i )
			cursor.next().setReal( LegacyStackImgLoaderLOCIUtils.getShortValue( b, i * 2, isLittleEndian ) );
	}
	...
	public static final < T extends RealType< T > > void readUnsignedInts( final byte[] b, final Cursor< T > cursor, final int width, final boolean isLittleEndian )
	{
		...
		{
			cursor.fwd();
			cursor.get().setReal( LegacyStackImgLoaderLOCIUtils.getIntValue( b, ( cursor.getIntPosition( 0 ) + cursor.getIntPosition( 1 ) * width ) * 4, isLittleEndian ) );
		}
	}
	...
	{
		for ( int i = 0; i < numPx; ++i )
			cursor.next().setReal( LegacyStackImgLoaderLOCIUtils.getIntValue( b, i * 4, isLittleEndian ) );
	}
	...
	public static final < T extends RealType< T > > void readFloats( final byte[] b, final Cursor< T > cursor, final int width, final boolean isLittleEndian )
	{
		...
		{
			cursor.fwd();
			cursor.get().setReal( LegacyStackImgLoaderLOCIUtils.getFloatValue( b, ( cursor.getIntPosition( 0 ) + cursor.getIntPosition( 1 ) * width ) * 4, isLittleEndian ) );
		}
	}
	...
	{
		for ( int i = 0; i < numPx; ++i )
			cursor.next().setReal( LegacyStackImgLoaderLOCIUtils.getFloatValue( b, i * 4, isLittleEndian ) );
	}
	...
	{
		String title = "Zeiss Lightsheet Z.1 Dataset Loader (Bioformats)"; 
		return title + ", ImgFactory=" + imgFactory.getClass().getSimpleName();
	}
}
